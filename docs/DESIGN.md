...
**"Pretendard Variable"** (primary): Pretendard is the best Korean font to simultaneously capture website performance and style by providing nine thicknesses (Weight 45-920) as a single file.
Fallbacks: Pretendard, Inter, -apple-system, system-ui, 'Segoe UI', Helvetica, sans-serif. Humanist-geometric character used across every UI surface.
